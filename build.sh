...
docker build \
    ...
    --build-arg NEXT_PUBLIC_STATUS_URL=${NEXT_PUBLIC_STATUS_URL} \
    ...
    --build-arg NEXT_PUBLIC_PLAUSIBLE_SITE=${NEXT_PUBLIC_PLAUSIBLE_SITE} \
    --build-arg NEXT_PUBLIC_PLAUSIBLE_ENABLED=${NEXT_PUBLIC_PLAUSIBLE_ENABLED} \
