...
import { Configure, Highlight, Hits, SearchBox } from "react-instantsearch";
			...
			{modalOpen && (
				<div className="fixed inset-0 z-50 flex items-start justify-center pt-20">
					<button
						...
						className="absolute inset-0 bg-black/25 backdrop-blur-xs dark:bg-white/25"
						onClick={() => setModalOpen(false)}
					/>
					<div
						role="dialog"
						aria-modal="true"
						className="relative z-10 m-3 w-full max-w-2xl rounded-lg bg-zinc-50 p-5 shadow-lg dark:bg-zinc-800"
					>
						<InstantSearchNext
